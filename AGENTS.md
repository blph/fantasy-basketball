...
One exception: the **2026-27 draft board** is built and in use. It is a Google Sheet generated by [scripts/draft-board/](scripts/draft-board/) from manual provider exports, standing in for the pipeline until Phase 2 lands ([ADR-0008](docs/decisions/ADR-0008-google-sheet-draft-board.md)).
...
Deeper docs: [data providers](docs/api/data-providers.md) · [database schema](docs/database/schema.md) · [decisions](docs/decisions/decision-log.md) · [draft board](scripts/draft-board/README.md) · [draft playbook](docs/references/fantasy-basketball-draft-playbook.md)
