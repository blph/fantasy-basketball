...
and only proceeds once the owner has agreed — the copy alone gets consent. The copy is
deleted afterwards because it is provider data in Drive. No credential or sharing change is
added, so the verdict stands.
